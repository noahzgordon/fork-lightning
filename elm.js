...
var author$project$Messages$AnimationFrameTriggered = function (a) {
	return {$: 'AnimationFrameTriggered', a: a};
};
...
var author$project$Main$subscriptions = function (model) {
	return elm$browser$Browser$Events$onAnimationFrame(author$project$Messages$AnimationFrameTriggered);
};
var author$project$Main$title = 'Fork Lightning';
...
var author$project$Main$arcLength = function (model) {
	return A2(elm$random$Random$float, (8 * model.zoom) + 1, (30 * model.zoom) + 2);
};
var author$project$Main$probability = A2(elm$random$Random$float, 0, 1);
var author$project$Model$Arc = function (a) {
	return {$: 'Arc', a: a};
};
...
var author$project$Main$iterateArc = F3(
	function (model, seed, _n0) {
		var arc = _n0.a;
		if (elm$core$List$isEmpty(arc.arcs)) {
			var _n1 = A2(elm$random$Random$step, author$project$Main$probability, seed);
			var rawArcProb = _n1.a;
			var seed1 = _n1.b;
			var arcProb = (rawArcProb * model.fremulation) * (11 / 10);
			var arcNum = (arcProb > 0.99) ? 2 : 1;
			var _n2 = A2(
				elm$random$Random$step,
				A2(
					...
					A2(
						...
						author$project$Main$arcLength(model),
						A2(elm$random$Random$float, arc.angle - 1.5, arc.angle + 1.5))),
				seed1);
			var arcVals = _n2.a;
			var seed2 = _n2.b;
			return author$project$Model$Arc(
				_Utils_update(
					arc,
					{
						arcs: A2(
							...
							function (_n3) {
								var length = _n3.a;
								var angle = _n3.b;
								return (arcNum === 1) ? author$project$Model$Arc(
									{angle: angle + ((arc.origAngle - angle) / 3), arcs: _List_Nil, length: length, origAngle: arc.origAngle}) : author$project$Model$Arc(
									{angle: angle, arcs: _List_Nil, length: length, origAngle: angle});
							},
							arcVals)
					}));
		} else {
					...
					arc,
					{
						arcs: A2(
							...
							function (_n5) {
								var subArc = _n5.a;
								var newSeed = _n5.b;
								return A3(author$project$Main$iterateArc, model, newSeed, subArc);
							},
							A2(elm_community$list_extra$List$Extra$zip, arc.arcs, seeds))
					}));
		}
	});
var elm$core$Basics$ge = _Utils_ge;
var elm$core$Basics$round = _Basics_round;
var author$project$Main$iterateBolt = F2(
	function (model, bolt) {
		var _n0 = A2(elm$random$Random$step, author$project$Main$probability, bolt.seed);
		var survivalProb = _n0.a;
		var seed1 = _n0.b;
		if ((_Utils_cmp(
			bolt.lifeTime,
			elm$core$Basics$round(60 * model.dilation)) < 0) || (((survivalProb * model.dilation) / bolt.lifeTime) >= 0.1)) {
			var _n1 = A2(
				elm$random$Random$step,
				A2(
					elm$random$Random$list,
					elm$core$List$length(bolt.arcs),
					elm$random$Random$independentSeed),
				seed1);
			var seeds = _n1.a;
			return elm$core$Maybe$Just(
					...
					bolt,
					{
						arcs: A2(
							...
							function (_n2) {
								var arc = _n2.a;
								var newSeed = _n2.b;
								return A3(author$project$Main$iterateArc, model, newSeed, arc);
							},
							A2(elm_community$list_extra$List$Extra$zip, bolt.arcs, seeds)),
...
var author$project$Main$makeNewBolt = F3(
	function (model, seed, coords) {
		var _n0 = A2(elm$random$Random$step, author$project$Main$probability, seed);
		var arcProbRaw = _n0.a;
		var seed1 = _n0.b;
		var arcProb = (arcProbRaw * model.chaos) * 2;
		var arcNum = (arcProb > 0.95) ? 3 : ((arcProb > 0.8) ? 2 : 1);
		var _n1 = A2(
			elm$random$Random$step,
			A2(
				elm$random$Random$list,
...
var author$project$Model$Coords = F2(
	function (x, y) {
		return {x: x, y: y};
	});
var author$project$Main$randomScreenPos = function (dims) {
	return A3(
		elm$random$Random$map2,
		author$project$Model$Coords,
		A2(elm$random$Random$float, 100, dims.width - 300),
		A2(elm$random$Random$float, 100, dims.height - 100));
};
...
var ianmackenzie$elm_geometry$Circle2d$contains = F2(
	function (point, circle) {
		...
		return _Utils_cmp(
			A2(
				ianmackenzie$elm_geometry$Point2d$squaredDistanceFrom,
...
var author$project$Main$randomScreenPosWithoutOverlap = F3(
	function (dims, points, distance) {
		return A2(
			...
			function (point) {
				return !A2(
					...
					function (_n0) {
						...
						var y = _n0.y;
						return A2(
							ianmackenzie$elm_geometry$Circle2d$contains,
			...
			author$project$Main$randomScreenPos(dims));
	});
...
var author$project$Main$generateBolts = F2(
	function (seed, model) {
		if (elm$core$List$isEmpty(model.bolts)) {
			var _n0 = A2(
				elm$random$Random$step,
				author$project$Main$randomScreenPos(model.window),
				seed);
			var boltPos = _n0.a;
			var seed1 = _n0.b;
			return _List_fromArray(
				[
					A3(author$project$Main$makeNewBolt, model, seed1, boltPos)
				]);
		} else {
			var currentBoltPositions = A2(
				elm$core$List$map,
				function ($) {
					return $.origin;
				},
				model.bolts);
			var _n1 = A2(elm$random$Random$step, author$project$Main$probability, seed);
			var rawNewBoltProb = _n1.a;
			var seed1 = _n1.b;
			var newBoltProb = (rawNewBoltProb * model.chaos) * 2;
			var boltNum = (elm$core$List$length(model.bolts) > 5) ? 0 : ((newBoltProb > 0.99) ? 1 : 0);
			var _n2 = A2(
				elm$random$Random$step,
				A2(
					elm$random$Random$list,
					...
					A2(
						elm$random$Random$pair,
						elm$random$Random$independentSeed,
						A3(author$project$Main$randomScreenPosWithoutOverlap, model.window, currentBoltPositions, 300))),
				seed1);
			var newBoltVars = _n2.a;
			var seed2 = _n2.b;
			var newBolts = A2(
				elm$core$List$map,
				function (_n3) {
					var newSeed = _n3.a;
					var pos = _n3.b;
					return A3(author$project$Main$makeNewBolt, model, newSeed, pos);
				},
				newBoltVars);
			return A2(
				elm$core$List$filterMap,
				author$project$Main$iterateBolt(model),
				_Utils_ap(model.bolts, newBolts));
		}
	});
...
var author$project$Main$update = F2(
	function (message, model) {
		if (message.$ === 'AnimationFrameTriggered') {
			var time = message.a;
			...
			return _Utils_Tuple2(
				_Utils_update(
					model,
					{
						bolts: A2(author$project$Main$generateBolts, seed0, model)
					}),
...
var author$project$Model$init = function (flags) {
	return _Utils_Tuple2(
		{bolts: _List_Nil, chaos: 0.5, dilation: 0.5, fremulation: 0.5, window: flags.window, zoom: 0.5},
		elm$core$Platform$Cmd$none);
};
...
var author$project$EffectView$arcColor = A3(avh4$elm_color$Color$rgb, 1, 1, 1);
...
var ianmackenzie$elm_geometry$Curve$ParameterValue$value = function (_n0) {
	var value_ = _n0.a;
	return value_;
};
...
var ianmackenzie$elm_geometry$Arc2d$pointOn = F2(
	function (_n0, parameterValue) {
		...
		var _n1 = ianmackenzie$elm_geometry$Point2d$coordinates(arc.startPoint);
		var x0 = _n1.a;
		var y0 = _n1.b;
		var _n2 = ianmackenzie$elm_geometry$Direction2d$components(arc.xDirection);
		var dx = _n2.a;
		var dy = _n2.b;
		if (arcSweptAngle === 0.0) {
			var distance = t * arcSignedLength;
			return ianmackenzie$elm_geometry$Point2d$fromCoordinates(
				_Utils_Tuple2(x0 + (distance * dx), y0 + (distance * dy)));
		} else {
			var theta = t * arcSweptAngle;
			var arcRadius = arcSignedLength / arcSweptAngle;
			var x = arcRadius * elm$core$Basics$sin(theta);
			var y = (_Utils_cmp(
				elm$core$Basics$abs(theta),
				elm$core$Basics$pi / 2) < 0) ? (x * elm$core$Basics$tan(theta / 2)) : (arcRadius * (1 - elm$core$Basics$cos(theta)));
			return ianmackenzie$elm_geometry$Point2d$fromCoordinates(
				_Utils_Tuple2((x0 + (x * dx)) - (y * dy), (y0 + (x * dy)) + (y * dx)));
		}
	});
var ianmackenzie$elm_geometry$Curve$ParameterValue$ParameterValue = function (a) {
	return {$: 'ParameterValue', a: a};
};
var ianmackenzie$elm_geometry$Curve$ParameterValue$one = ianmackenzie$elm_geometry$Curve$ParameterValue$ParameterValue(1);
var ianmackenzie$elm_geometry$Arc2d$endPoint = function (arc) {
	return A2(ianmackenzie$elm_geometry$Arc2d$pointOn, arc, ianmackenzie$elm_geometry$Curve$ParameterValue$one);
};
...
var ianmackenzie$elm_geometry$Direction2d$fromAngle = function (angle) {
...
var ianmackenzie$elm_geometry$Arc2d$with = function (properties) {
	var _n0 = ianmackenzie$elm_geometry$Point2d$coordinates(properties.centerPoint);
	var x0 = _n0.a;
	var y0 = _n0.b;
	return ianmackenzie$elm_geometry$Geometry$Types$Arc2d(
		{
			signedLength: elm$core$Basics$abs(properties.radius) * properties.sweptAngle,
			startPoint: ianmackenzie$elm_geometry$Point2d$fromCoordinates(
				_Utils_Tuple2(
					x0 + (properties.radius * elm$core$Basics$cos(properties.startAngle)),
					y0 + (properties.radius * elm$core$Basics$sin(properties.startAngle)))),
			sweptAngle: properties.sweptAngle,
			xDirection: ianmackenzie$elm_geometry$Direction2d$fromAngle(
				properties.startAngle + elm$core$Basics$degrees(90))
		});
};
var author$project$EffectView$drawArc = F2(
	function (_n0, _n1) {
		var x = _n0.x;
		var y = _n0.y;
		var arc = _n1.a;
		var _n2 = ianmackenzie$elm_geometry$Point2d$coordinates(
			ianmackenzie$elm_geometry$Arc2d$endPoint(
				ianmackenzie$elm_geometry$Arc2d$with(
					{
						centerPoint: ianmackenzie$elm_geometry$Point2d$fromCoordinates(
							_Utils_Tuple2(x, y)),
						radius: arc.length,
						startAngle: 0,
		...
		return _Utils_ap(
				...
				[
					...
					_List_fromArray(
						[
							...
							elm_community$typed_svg$TypedSvg$Types$px(endX)),
							elm_community$typed_svg$TypedSvg$Attributes$y2(
							elm_community$typed_svg$TypedSvg$Types$px(endY)),
							elm_community$typed_svg$TypedSvg$Attributes$stroke(author$project$EffectView$arcColor)
						]),
					_List_Nil)
				]),
			elm$core$List$concat(
				A2(
					elm$core$List$map,
					author$project$EffectView$drawArc(
						{x: endX, y: endY}),
					arc.arcs)));
	});
var author$project$EffectView$drawBolt = function (bolt) {
	return elm$core$List$concat(
		A2(
			elm$core$List$map,
			author$project$EffectView$drawArc(bolt.origin),
			bolt.arcs));
};
...
var author$project$EffectView$draw = function (model) {
	return A2(
		...
		_Utils_ap(
			...
			elm$core$List$concat(
				A2(elm$core$List$map, author$project$EffectView$drawBolt, model.bolts))));
};
var author$project$Messages$ModifierChanged = F2(
	function (a, b) {
		return {$: 'ModifierChanged', a: a, b: b};
	});
...
var author$project$View$modSlider = F2(
	function (model, _n0) {
		var modifier = _n0.a;
		var label = _n0.b;
		var prop = _n0.c;
		return A2(
			...
			A2(
					...
					]),
				{
					...
					max: 1,
					min: 0,
					onChange: author$project$Messages$ModifierChanged(modifier),
					step: elm$core$Maybe$Just(1.0e-2),
					thumb: mdgriffith$elm_ui$Element$Input$defaultThumb,
					value: prop(model)
				}));
	});
var author$project$Messages$Chaos = {$: 'Chaos'};
var author$project$Messages$Dilation = {$: 'Dilation'};
var author$project$Messages$Fremulation = {$: 'Fremulation'};
var author$project$Messages$Zoom = {$: 'Zoom'};
var author$project$View$mods = _List_fromArray(
	[
		_Utils_Tuple3(
		author$project$Messages$Fremulation,
		'fremulation',
		function ($) {
			return $.fremulation;
		}),
		_Utils_Tuple3(
		author$project$Messages$Chaos,
		'chaos quotient',
		function ($) {
			return $.chaos;
		}),
		_Utils_Tuple3(
		author$project$Messages$Dilation,
		'time dilation',
		function ($) {
			return $.dilation;
		}),
		_Utils_Tuple3(
		author$project$Messages$Zoom,
		'zoominess',
		function ($) {
			return $.zoom;
		})
...
var author$project$View$draw = function (model) {
	return _List_fromArray(
		[
			A2(
			...
			A2(
				...
				_List_fromArray(
					[
						...
						A2(
							elm$core$List$map,
							author$project$View$modSlider(model),
							author$project$View$mods)),
						A2(
						mdgriffith$elm_ui$Element$el,
						_List_fromArray(
							[
						...
						mdgriffith$elm_ui$Element$html(
							author$project$EffectView$draw(model)))
					])))
		]);
};
...
var author$project$Main$main = elm$browser$Browser$document(
	{
		...
		view: function (model) {
			return {
				body: author$project$View$draw(model),
